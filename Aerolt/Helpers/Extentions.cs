...
namespace Aerolt.Helpers
{
    public static class Extentions
    {
        ...
        public static void SetSize(this RectTransform source, RectTransform toCopy) => source.SetSize(toCopy.GetSize());

        /// <summary>
        ///     Sets the sources RT size to the same as the newSize.
        /// </summary>
        public static void SetSize(this RectTransform source, Vector2 newSize) => source.SetSize(newSize.x, newSize.y);
        ...
        public static void SetWidth(this RectTransform source, float width) => source.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, width);

        public static void SetHeight(this RectTransform source, float height) => source.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, height);
