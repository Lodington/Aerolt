...
namespace Aerolt.Helpers
{
    ...
    public class MovePanel : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (configEntry.Value.x < 0 - Screen.width / 2 || configEntry.Value.x > Screen.width - Screen.width / 2 ||
                configEntry.Value.y > Screen.height - Screen.height / 2 || configEntry.Value.y < 0 - Screen.height / 2)
